...
const LoadingState: React.FC<LoadingStateProps> = ({ 
  ...
  if (inline) {
    return (
      <div className="bg-white rounded-lg shadow-md border p-6 flex flex-col items-center justify-center w-full h-[200px]">
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4 z-50 bg-background/80">
      <div className="bg-white rounded-lg shadow-lg border p-8 w-full max-w-md flex flex-col items-center justify-center">
